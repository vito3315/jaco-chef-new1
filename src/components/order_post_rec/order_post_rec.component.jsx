  ...
  render() {
    return (
      ...
      >
        ...
        <DialogActions>
          <Button onClick={this.props.save.bind(this, this.state.point)}>
            Сохранить
          </Button>
        </DialogActions>
      </Dialog>
...
class OrderPostRec_ extends React.Component {
  ...
  search(event) {
    ...
    // console.log(this.state.catsCopy)
    ...
    if (searchValue !== '' || searchValue.length > 1) {
      ...
      //  this.setState({
      //   cats: this.state.catsCopy,
      //   freeItems: this.state.freeItemsCopy
      // });
    ...
    return (
      <>
        ...
        <Grid container spacing={3}>
                                        ...
                                        <TableCell>
                                          {it.items.length === 1 ? (
                                            ...
                                            <MySelect
                                              ...
                                              func={this.changeSelect.bind(this, it.id, 'item_id_rec')}
                                            />
                                          )}
                                        </TableCell>

                                        <TableCell>{it.pq_rec} {it.ei_name}</TableCell>

                                        <TableCell>
                                          {/* // {console.log(it.vendors)} */}
                                          ...
                                          {it.vendors ? (
                                            it.vendors.length === 1 ? (
                                              ...
                                              <MySelect
                                                ...
                                                func={this.changeSelect.bind(this, it.id, 'vendor_id_rec')}
                                              />
                                            )
                                          ) : null}
                                        </TableCell>
          ...
          {this.state.point < 1 || !this.state.hist.length ? null : (
