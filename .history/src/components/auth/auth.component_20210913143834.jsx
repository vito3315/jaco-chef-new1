          ...
          <Grid item xs={12} sm={6} md={6} lg={3} xl={3}>
            <div className={this.state.classes.paper}>
              <Avatar className={this.state.classes.avatar}>
                <img alt="Жако доставка роллов и пиццы" src="../assets/img_other/Favikon.png" style={{ height: 'auto', width: 'inherit' }} />
                <img alt="Жако доставка роллов и пиццы" src="../assets/text.jpeg" style={{ height: 'auto', width: 'inherit' }} />
              </Avatar>
