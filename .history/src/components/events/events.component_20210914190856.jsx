...
class Events_ extends React.Component {
  ...
  chooseDay(day, full_day, mounth){
    
    if( day ){
    
      this.setState({
        chooseDay: full_day+' '+mounth,
        modalDialog: true
      })
    }
  }
                  ...
                  <Table aria-label="a dense table" style={{ overflow: 'hidden' }}>
                    ...
                    <TableBody>
                      ...
                      { item.map( (mounth, m_key) =>
                        <TableRow key={m_key}>
                          { mounth.map( (day, k) =>
                            <TableCell onClick={ this.chooseDay.bind(this, day.day, day.full_day, day.mounth) } key={k} className={ day.holy ? this.state.classes.holyCel : this.state.classes.tableCel}> { day.day } </TableCell>
                          ) }
                        </TableRow>
                      ) }
