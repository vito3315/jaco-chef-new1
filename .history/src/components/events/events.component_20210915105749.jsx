          ...
          <DialogContent>
            <DialogContentText id="alert-dialog-description">
              ...
              <Grid container spacing={3}>
                ...
                { parseInt(this.state.chooseEvent) !== 1 ? null :
                  <>
                    <Grid item xs={12} sm={12}>
                    ...
                    <Grid item xs={12} sm={12}>
                      <MyCheckBox classes={this.state.classes} value={ this.state.everyYear1 } func={ this.changeCheckOrders.bind(this) } label='Каждый год' />
                    </Grid>
                  </>
                }
