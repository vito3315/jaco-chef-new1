        ...
        >
          ...
          <DialogContent>
            <DialogContentText id="alert-dialog-description">
              ...
              <div>
                <Accordion square expanded={this.state.expanded === 'panel1'} onChange={this.handleChange.bind(this, 'panel1')}>
                ...
                <Accordion square expanded={this.state.expanded === 'panel2'} onChange={this.handleChange.bind(this, 'panel2')}>
                ...
                <Accordion square expanded={this.state.expanded === 'panel3'} onChange={this.handleChange.bind(this, 'panel3')}>
